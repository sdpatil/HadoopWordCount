...
public class WordCountMR extends Configured implements Tool{
	...
	Logger logger = LoggerFactory.getLogger(WordCountMR.class);
	...
	//	job.getConfiguration().set("job.end.notification.url", "http://127.0.0.1:8080/mrnotification/MRNotification?jobName=Max Temperature");
